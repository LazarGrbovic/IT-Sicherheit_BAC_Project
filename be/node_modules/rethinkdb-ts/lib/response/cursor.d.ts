...
export declare class Cursor extends Readable implements RCursor {
    ...
    private resolving;
    private lastError;
    constructor(conn: RethinkDBSocket, token: number, runOptions: Pick<RunOptions, 'binaryFormat' | 'groupFormat' | 'timeFormat'>, query: QueryJson, results?: any[] | undefined, hasNextBatch?: boolean | undefined);
    init(): void;
    _read(): void;
    pause(): this;
    resume(): this;
    ...
    next(): Promise<any>;
    toArray(): Promise<any[]>;
    each(callback: (err: RethinkDBError | undefined, row?: any) => boolean, onFinishedCallback?: () => any): Promise<void>;
